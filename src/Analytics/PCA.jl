...
"""
    scree_plot(pca::RollingPCA)

UnicodePlots bar chart of explained variance per factor.
Useful for choosing the right number of factors (look for the elbow).
"""
function scree_plot(pca::RollingPCA)
